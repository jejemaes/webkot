...
class Template extends AbstractTemplate implements iTemplate{
	...
	public function render(){
		...
		$html .= '<head>';
			...
			/*$html .= '	<!-- Bootstrap core CSS -->
    					...
    					<link href="'.DIR_TEMPLATE.'coffee/css/style.css" rel="stylesheet">	
    					<!-- Bootstrap core JS -->
		...
		$html .= '<body>';	
			...
			if($this->getLayout() == "layout2col" || $this->getLayout() == "layout1col"){
				...
				$html .= '<img src="'.DIR_TEMPLATE . 'coffee/img/dessinLogo.png">';
				$html .= '</div>';*/
				...
				if($this->getLayout() == "layout2col"){	
					$html .= '<div class="row">';
						...
						$html .= '<h2>'.$this->getPageTitle().'  <span>&raquo;</span>  <small>'.$this->getPageSubtitle().'</small></h2>';
						$html .= '</div>';
					$html .= '</div><!-- /.row -->';
					$html .= '<div class="row">';
	...
	public function renderClosed(){
		...
		$html .= '<head>';
		$html .= '	<!-- Bootstrap core CSS -->
    					<link href="'.DIR_TEMPLATE.'coffee/css/bootstrap.css" rel="stylesheet">
    					<link href="'.DIR_TEMPLATE.'coffee/css/bootstrap_2.3.2_form.css" rel="stylesheet">
    					<link href="'.DIR_TEMPLATE.'coffee/css/login.css" rel="stylesheet">
	
    					<!-- Bootstrap core JS -->
    					<script src="'.DIR_TEMPLATE.'coffee/js/jquery.js"></script>
    				  	<script src="'.DIR_TEMPLATE.'coffee/js/bootstrap.js"></script>
	
    					<!-- CSS Template -->
    					<link href="'.DIR_TEMPLATE.'coffee/css/coffee.css" rel="stylesheet">
    					<link href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css" rel="stylesheet">
    					<link href="'.DIR_TEMPLATE.'coffee/font-awesome/css/font-awesome.min.css" rel="stylesheet">'."\n";
	...
	*/
		...
		$html .= '<!-- Bootstrap edge JavaScript -->
    				  <script src="'.DIR_TEMPLATE.'coffee/js/coffee.js"></script>
					  <script src="'.DIR_TEMPLATE.'coffee/js/bootstrap-modalmanager.js"></script>
					  <script src="'.DIR_TEMPLATE.'coffee/js/bootstrap-modal.js"></script>';
		$html .= "\n".'<!-- Additionnal JS Code Footer -->'."\n";
		$html .= $this->renderArray($this->getJsFooterTags());
		$html .= '</body>';
