...
/**
 * Class modified by MAES Jerome, so DO NOT REPLACE by the lastest version !
 * Historic : 
 * 		Setp 2012 : remove the Javascript
 * 		Nov 2012 : add the class JFormComponentCaptcha, using the constant CAPTCHA_PUBLIC_KEY, and based on the recaptchalib.php from Google
 */
...
class JFormer {
    ...
    function getHtml() {
        ...
        $previousButton = new JFormElement('button', array('class' => 'previousButton','style' => ' '));
        $previousButton->update('Previous');
        $previousButtonLi->insert($previousButton);

        // Create the next button
        $nextButtonLi = new JFormElement('li', array('class' => ''));
        $nextButton = new JFormElement('button', array('class' => 'button btn'));
...
class JFormComponentCaptcha extends JFormComponent {
    /*
     * Constructor
     */
    ...
    function __construct($id, $label, $optionArray = array()) {
        ...
        $this->name = $this->id;
        $this->label = $label;
        $this->class = 'jFormComponentCaptcha';
        $this->inputClass = 'captcha';
        $this->widthArray = array('shortest' => '5em', 'short' => '10em', 'medium' => '20em', 'long' => '30em', 'longest' => '40em');
        $this->heightArray = array('short' => '6em', 'medium' => '12em', 'tall' => '18em');
